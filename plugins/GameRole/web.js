...
module.exports.get = function(guildID) {
    return new Promise(async (res, rej) => {
        const data = await db.getGuildPluginAliasesAndPerms(guildID, "GameRole", {"gamerole":["gamerole"],"gamerolemessage":["gamerolemessage"]}, {"gamerole":[],"gamerolemessage":[]});
...
module.exports.put = function(guildID, data) {
    return new Promise(async (res, rej) => {
        Discord.getGuildRoles(guildID).then(roles => {
            ...
            db.setGuildPluginAliases(guildID, "GameRole", aliases);
            db.setGuildPluginPerms(guildID, "GameRole", perms);
            res();
        });
    });
}
