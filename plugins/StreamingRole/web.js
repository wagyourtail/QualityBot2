...
module.exports.get = function(guildID) {
    return new Promise(async (res, rej) => {
        const data = await db.getGuildPluginAliasesAndPerms(guildID, "StreamingRole", {"streamrole": ["streamrole"]}, {"streamrole":[]});
...
module.exports.put = function(guildID, data) {
    return new Promise(async (res, rej) => {
        Discord.getGuildRoles(guildID).then(roles => {
            ...
            db.setGuildPluginAliases(guildID, "StreamingRole", aliases);
            db.setGuildPluginPerms(guildID, "StreamingRole", perms);
            res();
        });
    });
}
