...
module.exports.get = function(guildID) {
    return new Promise(async (res, rej) => {
        const data = await db.getGuildPluginAliasesAndPerms(guildID, "Default", {"help":["help"],"permissions":["permissions"],"aliases":["aliases"],"setprefix":["setprefix"],"plugins":["plugins"]}, {"help":["@everyone"],"permissions":[],"aliases":[],"setprefix":[],"plugins":[]});
...
module.exports.put = function(guildID, data) {
    return new Promise(async (res, rej) => {
        Discord.getGuildRoles(guildID).then(roles => {
            ...
            db.setGuildPluginAliases(guildID, "Default", aliases);
            db.setGuildPluginPerms(guildID, "Default", perms);
            res();
        });
    });
}
