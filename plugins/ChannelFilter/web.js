...
module.exports.get = function(guildID) {
    return new Promise(async (res, rej) => {
        const data = await db.getGuildPluginAliasesAndPerms(guildID, "ChannelFilter", {"channelfilter":["channelfilter"]}, {"channelfilter":[]});
...
module.exports.put = function(guildID, data) {
    return new Promise(async (res, rej) => {
        Discord.getGuildRoles(guildID).then(roles => {
            ...
            db.setGuildPluginAliases(guildID, "ChannelFilter", aliases);
            db.setGuildPluginPerms(guildID, "ChannelFilter", perms);
            res();
        });
    });
}
