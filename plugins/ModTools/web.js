...
module.exports.get = function(guildID) {
    return new Promise(async (res, rej) => {
        const data = await db.getGuildPluginAliasesAndPerms(guildID, "ModTools", {"logchannel":["logchannel"], "logchanges":["logchanges"], "muterole":["muterole"], "mute":["mute"], "unmute":["unmute"], "prune":["prune"], "warn":["warn"], "kick":["kick"], "ban":["ban"], "unban":["unban"]}, {"logchannel":[], "logchanges":[], "muterole":[], "mute":[], "unmute":[], "prune":[], "warn":[], "kick":[], "ban":[], "unban":[]});
