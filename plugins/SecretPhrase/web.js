...
module.exports.get = function(guildID) {
    return new Promise(async (res, rej) => {
        const data = await db.getGuildPluginAliasesAndPerms(guildID, "SecretPhrase", {"secretphrase": ["secretphrase"]}, {"secretphrase": []});
...
module.exports.put = function(guildID, data) {
    return new Promise(async (res, rej) => {
        Discord.getGuildRoles(guildID).then(roles => {
            ...
            db.setGuildPluginAliases(guildID, "SecretPhrase", aliases);
            db.setGuildPluginPerms(guildID, "SecretPhrase", perms);
            res();
        });
    });
}
